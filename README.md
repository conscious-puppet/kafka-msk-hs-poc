...
nix run nixpkgs#omnix -- \
  init github:srid/kafka-aws-haskell -o ./yourproject
```
...
Full instructions: https://srid.ca/kafka-aws-haskell/start
...
- Run the application without installing: `nix run github:srid/kafka-aws-haskell` (or `nix run .` from checkout)
- Common workflows
  - Adding library dependencies in Nix: https://community.flake.parts/haskell-flake/dependency
  - Adding tests: https://srid.ca/kafka-aws-haskell/tests

## Discussions

Questions? Ideas? Suggestions? Join our [NixOS Asia community](https://nixos.asia/en/#community) or post in [Github Discussions](https://github.com/srid/kafka-aws-haskell/discussions).
